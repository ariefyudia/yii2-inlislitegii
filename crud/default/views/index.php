...
?>
            ...
            [
				...
				'update' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['<?=!empty($generator->moduleID) ? $generator->moduleID."/" : ""; ?><?=$generator->controllerID?>/update',<?= $urlParams ?>,'edit'=>'t']), [
                                                    'title' => Yii::t('app', 'Edit'),
                                                    'class' => 'btn btn-primary btn-sm'
                                                  ]);},
												  
                'delete' => function ($url, $model) {
                                    return Html::a('<span class="glyphicon glyphicon-trash"></span>', Yii::$app->urlManager->createUrl(['<?=!empty($generator->moduleID) ? $generator->moduleID."/" : ""; ?><?=$generator->controllerID?>/delete',<?= $urlParams ?>,'edit'=>'t']), [
